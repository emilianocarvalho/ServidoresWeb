...
This project is a fork the [material-start](https://github.com/angular/material-start) following the episode of angularjs series of Rodrigo Branas [Rogrido Branas youtube](https://github.com/rodrigobranas/youtube)
...
[Material-Start](https://github.com/emilianocarvalho/ServidoresWeb/tree/master/material-start) repository and install the dependencies:
...
```
git clone https://github.com/emilianocarvalho/ServidoresWeb/tree/master/material-start
cd material-start
```
...
```bash
git clone --depth=1 https://github.com/emilianocarvalho/ServidoresWeb/tree/master/material-start <your-project-name>
```
